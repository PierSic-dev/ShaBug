...
class CameraModel: NSObject {
    ...
    @Published var photoResult: CVPixelBuffer?
    ...
    func takePhoto() {
        ...
        sessionQueue.async {
            ...
            print("Photo passed to the delegate")
        }
    }
}
...
extension CameraModel: AVCapturePhotoCaptureDelegate {
    ...
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        ...
        photoResult = photo.previewPixelBuffer
        
        if photoResult != nil {
            print("photoResult is NOT nil")
            print(photoResult!)
        } else {
            print("photoResult is nil")
        }
